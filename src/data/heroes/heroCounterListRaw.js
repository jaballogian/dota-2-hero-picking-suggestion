...
const heroCounterListRaw = [
  ...
  },
  {
    ...
    "Bad against": "Anti-Mage, Brewmaster, Lycan, Mirana, Oracle, Phantom Lancer, Phoenix, Terrorblade, Viper, Void Spirit, Weaver",
    "Good against": "Abaddon, Alchemist, Chen, Crystal Maiden, Dazzle, Death Prophet, Huskar, Io, Morphling, Snapfire, Winter Wyvern",
    "Works well with": "Bloodseeker, Faceless Void, Meepo, Necrophos, Oracle, Shadow Demon, Slark, Venomancer, Winter Wyvern"
  },
  {
    "Hero": "Anti-Mage",
  ...
  {
    "Hero": "Phantom Lancer",
    "Bad against": "Axe, Batrider, Bristleback, Centaur Warrunner, Dragon Knight, Earthshaker, Ember Spirit, Grimstroke, Gyrocopter, Hoodwink, Jakiro, Kunkka, Legion Commander, Leshrac, Meepo, Magnus, Pangolier, Phoenix, Puck, Razor, Sand King, Storm Spirit, Sven, Tidehunter, Timbersaw, Void Spirit, Witch Doctor",
  ...
  },
  {
    ...
    "Good against": "Bloodseeker, Doom, Legion Commander, Necrophos, Rubick, Techies, Witch Doctor, Pudge",
